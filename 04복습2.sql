...
select last_name, to_char(hire_date, 'YYYY.MM.DD') hire_date,
    to_char(next_day(add_month(hire_date, 3), 'monday'), 'YYYY.MM.DD') review_date
from employees;
...
select last_name || ' earns ' ||
    to_char(salary, 'fm$99,999') || ' monthly but wnats ' ||
...
select cast job_id when '1' then 1
                    when '2' then 2
                    else 0
        end grade
from employees;
